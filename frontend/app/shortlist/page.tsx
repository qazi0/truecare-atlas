          ...
          <div className="overflow-x-auto">
            <table className="w-full text-[12px]">
              ...
              <tbody>
                ...
                {!loading && facilities.length === 0 && <tr><td colSpan={comparison ? 7 : 6} className="p-6"><EmptyState title="No facilities selected" detail="Add facilities from Command or Facility Detail." /></td></tr>}
              </tbody>
            </table>
          </div>
        </div>
